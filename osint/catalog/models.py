...
class Administrator(models.Model):
    name = models.CharField('Nombre', max_length=50, help_text='Nombre completo')
    charge = models.CharField('Cargo', max_length=30, help_text='Cargo en la entidad')
    start_date = models.DateField('Desde', help_text='Fecha en la que empezó con el cargo', null=True, blank=True)
    untill = models.DateField('Hasta', help_text='Fecha de cese', null=True, blank=True, default=timezone.datetime.today)
